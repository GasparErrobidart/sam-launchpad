...
function deploy(opts){
  ...
  return new Promise((resolve,reject)=>{
    ...
    apps.forEach(app=>{
      ...
      exec(`sam deploy --template-file ${config.base_path}${app ? '/'+app : ''}/packaged-${args.environment}.yaml --stack-name ${stackName} --capabilities CAPABILITY_IAM --parameter-overrides Environment=${args.environment} ProjectName=${config.project_name + additionalParameters}`,
